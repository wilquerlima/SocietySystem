	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.idGrupo}">
				<li class="fieldcontain">
					<span id="idGrupo-label" class="property-label"><g:message code="usuario.idGrupo.label" default="Id Grupo" /></span>
					
						<span class="property-value" aria-labelledby="idGrupo-label"><g:fieldValue bean="${usuarioInstance}" field="idGrupo"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${usuarioInstance?.isOwner}">
				<li class="fieldcontain">
					<span id="isOwner-label" class="property-label"><g:message code="usuario.isOwner.label" default="Is Owner" /></span>
					
						<span class="property-value" aria-labelledby="isOwner-label"><g:formatBoolean boolean="${usuarioInstance?.isOwner}" /></span>
